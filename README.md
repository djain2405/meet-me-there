...
3. **Match groups:** assign attendees into groups of 3 to 5, set meeting details and chat links
...
| When | Action |
|------|--------|
| 1 to 2 weeks before | Create event, share signup link |
| 3 to 5 days before | Review signups, start matching |
| 24 to 48 hours before | Finalize groups, send meeting instructions |
